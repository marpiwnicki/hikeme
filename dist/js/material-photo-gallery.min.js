! function t(e, i, n) {
    ...
    (function() {
      ...
      s.getListeners = function(t) {
        ...
        var n, s = this.getListenersAsObject(t),
          o = "object" == typeof e;
        for (n in s) s.hasOwnProperty(n) && i(s[n], e) === -1 && s[n].push(o ? e : {
          listener: e,
          once: !1
        });
        return this
        ...
        for (s in o) o.hasOwnProperty(s) && (n = i(o[s], e), n !== -1 && o[s].splice(n, 1));
        return this
    ...
    ! function(t, n) {
      ...
      function e() {
        ...
        var c = t("span", n.CONTROLS_BTN),
          ...
          d = t("span", n.CONTROLS_BTN);
        return c.innerHTML = s, f.innerHTML = r, d.innerHTML = o, i.appendChild(c), l.appendChild(f), h.appendChild(d), e
      }
      var i = {},
        n = {
  ...
  6: [function(t, e, i) {
    ! function(n, s) {
      ...
      function o(t) {
        _ = s(t)[0].clientX, v = s(t)[0].clientY
      }
      ...
      function r(t) {
        if (_ && v) {
          var e = t.touches[0].clientX,
            ...
            n = _ - e,
            s = v - i;
          Math.abs(n) > Math.abs(s) && (n > 0 ? this._handleNext() : this._handlePrev()), _ = null, v = null
        }
      }
      var l = function(t) {
        ...
        h = !1,
        a = "transform",
        u = "Webkit Moz ms".split(" "),
        c = "",
        f = document.createElement("div");
      if (void 0 !== f.style.transform && (h = !0), h === !1)
        for (var d = 0; d < u.length; d++)
          if (void 0 !== f.style[u[d] + "Transform"]) {
            c = u[d], a = c + "Transform", h = !0;
            break
          } var m, g = {
        ...
        f = document.createElement("div");
      for (var p in g)
        if ("undefined" != typeof f.style[p]) {
          m = g[p];
          break
        } var _ = null,
        v = null;
      return l.prototype._cssClasses = {
        GALLERY: "m-p-g",
        ...
        for (var t = 0, e = this._thumbs.length; t < e; t++) this._thumbs[t].addEventListener("click", this._handleThumbClick.bind(this)), this._thumbs[t].addEventListener("mouseover", this._handleThumbHover.bind(this));
        this._closeBtn.addEventListener("click", this._handleClose.bind(this)), this._nextBtn.addEventListener("click", this._handleNext.bind(this)), this._prevBtn.addEventListener("click", this._handlePrev.bind(this)), window.addEventListener("scroll", this._handleScroll.bind(this)), document.addEventListener("touchstart", o.bind(this)), document.addEventListener("touchmove", r.bind(this))
      }, l.prototype._handleScroll = n(function() {
        this._resetFullImg.call(this)
      }, 25), l.prototype._handleResize = function() {
        this._resetFullImg.call(this)
      }, l.prototype._loadFullImgs = function() {
        for (var t, e, i = 0, n = this._thumbs.length; i < n; i++) t = this._thumbs[i].getAttribute("data-full"), e = new Image, e.src = t, e.classList.add(this._cssClasses.FULL_IMG), this._fullBox.appendChild(e);
        this._loadFullImgsDone.call(this)
      }, l.prototype._loadFullImgsDone = function() {
      ...
      }, l.prototype._positionFullImgs = function(t, e, i) {
        var n = this._transformFullImg(t, this._thumbs[e]);
        this._fullImgsTransforms.push(n), t.style.marginTop = -t.height / 2 + "px", t.style.marginLeft = -t.width / 2 + "px", i !== !1 && (t.style[a] = n)
      }, l.prototype._transformFullImg = function(t, e, i) {
        var n, s, o, r;
        ...
        return l
      }, l.prototype._resetFullImg = function() {
        this._fullImgsTransforms = [];
        for (var t = 0, e = this._fullImgs.length; t < e; t++) {
          ({
      ...
      }, l.prototype._handleThumbHover = function(t) {
        this._fullImgsLoaded && !this._fullImgOpen && this._transformThumbSetup.call(this, t)
      }, l.prototype._handleThumbClick = function(t) {
      ...
      }, l.prototype._transformThumbSetup = function(t, e) {
      ...
      }, l.prototype._activateFullImg = function() {
        this._thumb.classList.add("hide"), this._fullImg.classList.add("active"), this._fullImg.style[a] = "translate3d(0,0,0)", this._fullImgOpen = !0, this._fullImgs.forEach(function(t) {
          t.classList.contains("active") || t.classList.add("almost-active")
        })
      }, l.prototype._activateFullBox = function() {
        this._fullBox.classList.add("active")
      }, l.prototype._activateControls = function() {
        this._controls.classList.add("active")
      }, l.prototype._handleClose = function() {
        this._fullImgOpen && this._closeFullImg.call(this)
      }, l.prototype._closeFullImg = function() {
        var t = function() {
          this._fullBox.classList.remove("active"), this._controls.classList.remove("active"), this._fullImg.style[a] = this._fullImgsTransforms[this._thumbIndex], this._thumb.classList.remove("hide"), this._fullImgs.forEach(function(t) {
            t.classList.remove("almost-active")
          });
          var t = function() {
            this._fullImg.classList.remove("active"), this._fullImg.removeEventListener(m, t), this._fullImgOpen = !1
          }.bind(this);
          this._fullImg.addEventListener(m, t), this._enableScroll()
        }.bind(this);
        window.requestAnimationFrame(t)
      }, l.prototype._handleNext = function() {
        this._fullImgOpen && this._changeImg.call(this, "next")
      }, l.prototype._handlePrev = function() {
        this._fullImgOpen && this._changeImg.call(this, "prev")
      }, l.prototype._changeImg = function(t) {
        this._thumbIndex = this._fullImgs.indexOf(this._fullImg), "next" === t ? this._thumbIndex += 1 : this._thumbIndex -= 1, this._newFullImg = "next" === t ? this._fullImg.nextElementSibling : this._fullImg.previousElementSibling, this._newFullImg && "IMG" === this._newFullImg.nodeName || (this._newFullImg = "next" === t ? this._newFullImg = this._fullImgs[0] : this._newFullImg = this._fullImgs[this._fullImgs.length - 1], "next" === t ? this._thumbIndex = 0 : this._thumbIndex = this._fullImgs.length - 1), this._newFullImg.style[a] = "translate3d(0,0,0)", this._fullImg.classList.remove("active"), this._fullImg.style[a] = this._fullImgsTransforms[this._thumbIndex - 1], this._fullImg = this._newFullImg, this._fullImg.classList.add("active")
      }, l.prototype._disableScroll = function() {
        function t(t) {
          t = t || window.event, t.preventDefault && t.preventDefault(), t.returnValue = !1
        }
        window.onwheel = t, window.ontouchmove = t
      }, l.prototype._enableScroll = function() {
  ...
  7: [function(t, e, i) {
    ! function(t, n) {
      ...
      return e.init = function(t) {
        t = t || {};
        for (var i, n = document.querySelectorAll("div[data-google-image-layout]"), s = n.length, o = 0; o < s; o++) i = n[o], e.align(i);
        t.after && t.after()
      }, e.align = function(t) {
        var e = t.clientWidth,
